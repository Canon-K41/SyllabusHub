...
const CourseEditor: React.FC<CourseEditorProps> = ({ course }) => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log('Submitted data:', classData);
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                label="曜日"
                name="dayOfWeek"
                value={classData.dayOfWeek.join(', ')}
                  ...
                  <TableRow key={index}>
                    ...
                    <TableCell>
                      <Select
                        ...
                        onChange={(e) => handleAttendanceChange(index, 'status', e.target.value as 'absent' | 'present' | 'late')}
                        fullWidth
                      >
                    ...
                    <TableCell>
                      <IconButton onClick={() => removeAttendance(index)} color="error">
                        <DeleteIcon />
                      </IconButton>
                    </TableCell>
                  </TableRow>
